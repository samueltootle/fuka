...
CFMS_BHNS_Exporter::CFMS_BHNS_Exporter(CFMS_BHNS_Exporter const& r) {
    std::string error_msg = export_utils::throw_no_multithreaded_support_error(
        "CFMS_BHNS_Exporter - Copy Constructor");
    throw std::runtime_error(error_msg);
}

CFMS_BHNS_Exporter& CFMS_BHNS_Exporter::operator=(const CFMS_BHNS_Exporter& b) {
    std::string error_msg = export_utils::throw_no_multithreaded_support_error(
        "CFMS_BHNS_Exporter - Assignment operator");
    throw std::runtime_error(error_msg);
}
#endif
...
CFMS_BHNS_Exporter::interp_ary_t CFMS_BHNS_Exporter::interpolate_pointwise(
    double const& x,
    double const& y,
    double const& z,
    ...
    double const& ycom_shift =
        (*bconfig)(Kadath::FUKA_Config::BIN_PARAMS::COMY);
...
CFMS_BHNS_Exporter::output_ary_t CFMS_BHNS_Exporter::export_pointwise(
    ...
    return EOS_Function_Dispatcher::dispatch<
        CFMS_BHNS_Exporter::export_pointwise_imp>(*bconfig,
                                                  eos_type,
                                                  *this,
                                                  x,
                                                  y,
