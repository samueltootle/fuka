...
class bns_reader_t : public Kadath::python_reader_t<space_t, bns_vars_t> {
  ...
  struct compute_defs {
    ...
    void operator()(kadath_config_boost<BIN_INFO> bconfig,
      ...
      FUKA_Syst_tools::syst_vars_NS(this_reader->vars, syst, space.ADAPTED1 + 1,
                                    bconfig(MADM, BCO1), NS1_int_Domains,
                                    "NS1_");
      FUKA_Syst_tools::syst_vars_NS(this_reader->vars, syst, space.ADAPTED2 + 1,
                                    bconfig(MADM, BCO2), NS2_int_Domains,
                                    "NS2_");
      ...
      FUKA_Syst_tools::export_radii(space, this_reader->vars, space.ADAPTED1,
                                    space.NS2, "NS1_R");
      FUKA_Syst_tools::export_radii(space, this_reader->vars, space.ADAPTED2,
                                    space.OUTER, "NS2_R");
    }
  };
