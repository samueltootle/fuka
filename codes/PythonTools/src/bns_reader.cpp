    ...
    struct compute_defs {
        ...
        void operator()(kadath_config_boost<BIN_INFO> bconfig,
            ...
            std::vector<int> NS1_int_Domains{
                FUKA_Syst_tools::vector_of_domains(space.NS1,
                                                   space.ADAPTED1 + 1)};
            std::vector<int> NS1_ext_Domains{
                FUKA_Syst_tools::vector_of_domains(space.ADAPTED1 + 1,
                                                   space.NS2)};
            std::vector<int> NS2_int_Domains{
                FUKA_Syst_tools::vector_of_domains(space.NS2,
                                                   space.ADAPTED2 + 1)};
            std::vector<int> NS2_ext_Domains{
                FUKA_Syst_tools::vector_of_domains(space.ADAPTED2 + 1,
                                                   space.OUTER)};
            std::vector<int> vac_Domains{
                FUKA_Syst_tools::vector_of_domains(space.ADAPTED2 + 1, ndom)};
            // Include vacuum domains around NS1
            std::for_each(NS1_ext_Domains.rbegin(),
                          NS1_ext_Domains.rend(),
                          [&vac_Domains](auto e) {
            ...
            FUKA_Syst_tools::syst_init_eqdefs_hydro(syst,
                                                    NS1_int_Domains,
                                                    "s^i  = omesm * mm^i");
            FUKA_Syst_tools::syst_init_eqdefs_hydro(syst,
                                                    NS2_int_Domains,
