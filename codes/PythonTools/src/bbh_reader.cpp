...
class bbh_reader_t : public Kadath::python_reader_t<space_t, bbh_vars_t> {
 ...
 public:
  ...
  void compute_defs() {
    ...
    std::vector<int> vac_Domains{FUKA_Syst_tools::vector_of_domains(0, ndom)};
    ...
    FUKA_Syst_tools::syst_init_quasi_local_defs(syst, BH1_Domains, "mm", "sm");
    FUKA_Syst_tools::syst_init_quasi_local_defs(syst, BH2_Domains, "mp", "sp");
    ...
    FUKA_Syst_tools::export_radii(space, vars, space.BH1 + 1, space.BH2,
                                  "BH1_R");
    FUKA_Syst_tools::export_radii(space, vars, space.BH2 + 1, space.OUTER,
                                  "BH2_R");
