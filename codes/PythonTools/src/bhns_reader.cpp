...
template <>
Kadath::var_vector Kadath::vars_base_t<bhns_vars_t>::vars = {
    {"conf", SCALAR},
    {"lapse", SCALAR},
    {"shift", VECTOR},
    {"logh", SCALAR},
    ...
    struct compute_defs {
        ...
        void operator()(kadath_config_boost<BIN_INFO> bconfig,
            ...
            std::vector<int> NS_int_Domains{
                FUKA_Syst_tools::vector_of_domains(space.NS,
                                                   space.ADAPTEDNS + 1)};
            std::vector<int> NS_ext_Domains{
                FUKA_Syst_tools::vector_of_domains(space.ADAPTEDNS + 1,
                                                   space.BH)};
            ...
            FUKA_Syst_tools::syst_vars_BH(this_reader->vars,
                                          syst,
                                          space.ADAPTEDBH + 1,
                                          "BH_");
