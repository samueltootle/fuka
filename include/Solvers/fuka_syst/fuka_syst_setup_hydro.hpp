 ...
 */
inline void syst_init_contraction_defs_hydro(System_of_eqs& syst) {
#ifdef DEBUG
 ...
 */
inline void syst_init_eqdefs_hydro_corot(System_of_eqs& syst,
                                         std::vector<int> doms) {
#ifdef DEBUG
 ...
 */
inline void syst_init_eqdefs_hydro(System_of_eqs& syst,
                                   std::vector<int> doms,
                                   std::string spin_def) {
#ifdef DEBUG
 ...
 * @param doms vector of domains to populate these definitions
 */
inline void syst_init_quasi_local_defs_hydro(System_of_eqs& syst,
                                             std::vector<int> doms) {
#ifdef DEBUG
