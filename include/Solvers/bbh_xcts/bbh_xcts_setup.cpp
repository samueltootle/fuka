...
inline void bbh_xcts_setup_boosted_3d(
  ...
  Space_bin_bh space(type_coloc, bconfig(BIN_PARAMS::DIST), BH1_bounds,
                     BH2_bounds, out_bounds, bconfig(BIN_PARAMS::BIN_RES));
  Base_tensor basis(space, CARTESIAN_BASIS);

  auto interp_BH_fields = [&](auto& bhconf, auto& bhlapse, auto& bhshift,
                              auto& bhspacein) {
