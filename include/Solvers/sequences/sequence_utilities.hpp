...
/**
 * @brief Non-recursive search for number of detected sequences based on the
 * given inputs - needed to verify only one sequence is present.
 *
...
/**
 * ostream operator<<
 * Overloaded operator<< to handle printing Parameter Sequences to standard
 * output
 *
...
/**
 * ostream operator<<
 * Overloaded operator<< to handle printing Resolution Sequences to standard
 * output
 *
 * @tparam Ts Enum types
 * @param out: output stream
