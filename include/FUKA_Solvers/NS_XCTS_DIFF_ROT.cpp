...
template <class eos_t>
std::string NS_XCTS_DIFF_ROT<eos_t>::converged_filename(
...
void NS_XCTS_DIFF_ROT<eos_t>::setup_syst() {
  ...
  std::string firstint{
      "firstint = (H + log(N) - log(W)) - 0.5 * j^2 / diffA^2"};
  ...
  // integral below
  syst->add_eq_first_integral(0, 1, "firstint",
